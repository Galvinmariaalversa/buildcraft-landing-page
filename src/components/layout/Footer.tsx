  ...
  return (
    <footer className="bg-navy-950 text-slate-400 font-sans border-t border-white/5 relative overflow-hidden">
      ...
      <div className="border-t border-white/5 py-8">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs tracking-wider uppercase text-slate-400">
